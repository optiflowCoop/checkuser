    ...
    <div id="tab-tabela" class="container tab-content">
        <div class="card">
            <div style="display:flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
                <h3 style="margin: 0;">Plano de Ação Mestre e Fatores de Escala</h3>
            ...
            <p class="card-desc">Uma linha por usuário no plano de licenciamento, com a recomendação de otimização aplicada e os fatores que a justificam.</p>
