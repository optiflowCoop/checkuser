...
def build_html():
    ...
    html.append('<h2 class="card-header" onclick="toggleSection(\'section1\')">1. Resumo Executivo Operacional (Contas Ativas) <span class="toggle-icon">Ôû╝</span></h2>')
    html.append('<div id="section1" class="card-content">')
    html.append('<div class="stats-grid">')
    
    html.append(f'<div class="stat-card border-success"><div class="stat-value" style="color: var(--success);">{fmt_br(unique_active_logins)}</div><div class="stat-title">Pessoas ├Ünicas Ativas</div><div class="stat-subtitle">"Pessoas f├¡sicas" projetadas para o MAS 9</div></div>')
    html.append(f'<div class="stat-card border-accent"><div class="stat-value">{fmt_br(active_records)}</div><div class="stat-title">Registros Ativos</div><div class="stat-subtitle">Contas log├íveis no Maximo hoje</div></div>')
    ...
    html.append(f'<div class="stat-card border-danger"><div class="stat-value" style="color: var(--danger);">{fmt_br(critical_diff_active)}</div><div class="stat-title">Colis├Áes Cr├¡ticas</div><div class="stat-subtitle">Nomes diferentes no mesmo login</div></div>')
    html.append(f'<div class="stat-card border-accent"><div class="stat-value" style="color: var(--accent);">{fmt_br(active_profiles_with_context)}</div><div class="stat-title">Ativos com Perfil</div><div class="stat-subtitle">Usu├írios ativos com Title/PersonGroup</div></div>')
    html.append(f'<div class="stat-card border-neutral"><div class="stat-value" style="color: #64748b;">{fmt_br(total_records)}</div><div class="stat-title">Total Hist├│rico Legado</div><div class="stat-subtitle">Todos os registros brutos da tabela</div></div>')
    html.append('</div>')
    ...
    html.append('<div class="card">')
    html.append('<h2 class="card-header" onclick="toggleSection(\'section5legacy\')">7. ­ƒôè Vis├úo Legada: Auditoria de Perfis (Modo Comparativo) <span class="toggle-icon">Ôû╝</span></h2>')
